...
def startquiz():
    ...
    def check_ans():
        ...
        # Question Buttons
        r1 = Radiobutton(win2, text=radiobutton1[counter], variable=var1,
                         value=1, font="times",
                         bg="#ffffff").place(x=190, y=260)
        r2 = Radiobutton(win2, text=radiobutton2[counter], variable=var1,
                         value=2, font="times",
                         bg="#ffffff").place(x=300, y=260)
        ...
        label5 = Label(win2, text=question[counter], font="times",
                       fg="black", bg="#ffffff", wraplength=280,
                       justify=CENTER).place(x=200, y=120)
        label6 = Button(win2, text="Next question", command=check_ans,
    ...
    def calc_score():
        ...
        if score < na:
            label12 = Button(win1, text="Not achieved", font="times", fg="black",
    ...
    r2 = Radiobutton(win2, text=radiobutton2[counter],
                     variable=var1, value=2, font="times",
                     bg="#ffffff").place(x=300, y=260)
    r3 = Radiobutton(win2, text=radiobutton3[counter],
                     variable=var1, value=3, font="times",
                     bg="#ffffff").place(x=410, y=260)
    ...
    label5 = Label(win2, text=question[counter], font="times",
                   ...
                   justify=CENTER).place(x=200, y=120)
    label6 = Button(win2, text="Next question", command=check_ans,
                    state=state1, font="times", fg="black",
                    bg="#9cc2ff", padx=30, pady=3).place(x=90, y=310)
...
label1 = Button(win1, text="Quiz game", font="times", fg="black",
                bg="#ffffff", padx=30, pady=10).place(x=260, y=20)
lable2 = Button(win1, text="Start quiz", command=startquiz, state=state1,
                font="times", fg="black", bg="#9cc2ff",
                padx=30, pady=3).place(x=90, y=310)
label3 = Button(win1, text="End quiz", command=endquiz, font="times",
                fg="black", bg="#9cc2ff",
                padx=30, pady=3).place(x=400, y=310)
