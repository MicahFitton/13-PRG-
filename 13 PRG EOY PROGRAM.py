...
# Randomizer for the questions, creates a list called questions_for_display  which is then used in the counter variable to print a certain question lower
questions_for_display = []
for loop in range(11):
    my_random_int = choice(list(set(range(0, 13)) -\
        set(questions_for_display))) #lower
...
# Next question Function
    ...
    #Question Buttons
        r1 = Radiobutton(win2, text=radiobutton1[counter], variable=var1, value=1, font="times",bg="#ffffff").place(x=190, y=220)
        r2 = Radiobutton(win2, text=radiobutton2[counter], variable=var1, value=2, font="times",bg="#ffffff").place(x=300, y=220)
        r3 = Radiobutton(win2, text=radiobutton3[counter], variable=var1, value=3, font="times",bg="#ffffff").place(x=410, y=220)
        ...
        label5 = Label(win2, text=question[counter],font="times",fg="black", b ="#ffffff",wraplength=280,justify=CENTER).place(x=280, y=120)
        label6 = Button(win2, text="Next question" ,command=check_ans,state = state1,font="times", fg="black",bg="#ffffff",padx=30, pady=3).place(x=90, y=310 )
    ...
    def calc_score():
        ...
        #label13 = Button(win1, text = "Retry Quiz", command= newquiz, font = "times", fg = "black",bg = "#ffffff", padx = 30, pady=3).place(x=400, y = 310) lower
        label3 = Button(win1, text="End quiz", command=endquiz,font="times", fg="black", bg="#ffffff", padx=30, pady=3).place(x=400, y=310) #lower
    ...
    label5 = Label(win2, text = question[counter],font = "times",fg = "black", bg = "#ffffff",wraplength=280, justify=CENTER).place(x = 230, y= 120)
    label6 = Button(win2, text = "Next question" ,command=check_ans,state = state1,font = "times", fg = "black",bg = "#ffffff",padx = 30, pady = 3).place(x=90,y=310)
    #label12 = Button(win2, text = "Skip", command=skips, font = "Corbel_Light").place(x = 0, y = 0)
...
lable2 = Button(win1, text="Start quiz",command=startquiz, state=state1, font="times", fg="black", bg="#ffffff", padx=30, pady=3).place(x=90, y=310)
